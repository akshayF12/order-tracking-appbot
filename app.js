...
(function() {
        setTimeout(() => {
            $.ajax ({
                url: `https://e284-122-170-106-103.ngrok.io/shop-app-active-status-frontend?shop=${ord_domain}`,
                type: "GET",
                ...
                success:  function(data) {  
                  if (data.app_status == 'Disabled') {
                    ...
                    $('head').append('<link href="https://e284-122-170-106-103.ngrok.io/newapp.css" rel="stylesheet" crossorigin="anonymous">');
 ...
 function  appendApp (open) {    
    $(document).ready(function() {
        $.ajax ({
            url: "https://e284-122-170-106-103.ngrok.io/wigets-index",
            type: "GET",
            beforeSend: function(xhr){xhr.setRequestHeader('Accept', '*/*');},
            success:  function(data) { 
                // console.log(data); 
...
const getRewardData = async () => { 
    ...
    $('#app_index_body').empty();
        ...
        $.ajax({
            url: "https://e284-122-170-106-103.ngrok.io/get-reward-point",
            type: "GET",
            beforeSend: function(xhr){xhr.setRequestHeader('Accept', '*/*');},
            success: function(data) { 
                // console.log(data); 
...
function checkrewardtPage() {
    ...
    $('#app_index_body').empty();
        ...
        $.ajax({
            url: "https://e284-122-170-106-103.ngrok.io/check-reward-point",
            type: "GET",
            beforeSend: function(xhr){xhr.setRequestHeader('Accept', '*/*');},
            success: function(data) { 
                // console.log(data); 
...
$('#app_spinner').show();
$.ajax({
    url: "https://e284-122-170-106-103.ngrok.io/faq-page",
    type: "GET",
    beforeSend: function(xhr){xhr.setRequestHeader('Accept', '*/*');},
    success: function(data) { 
      //   console.log(data); 
...
function trackorderPage() {
 $('#page').attr('page', 'track_oder_body');
  ...
  $('#app_index_body').empty();
      ...
      $.ajax({
          url: "https://e284-122-170-106-103.ngrok.io/track-order",
          type: "GET",
          beforeSend: function(xhr){xhr.setRequestHeader('Accept', '*/*');},
          success: function(data) { 
            //   console.log(data); 
...
const getcodeData = async(data) => { 
    return new Promise((resolve, reject) => {
        ...
        $('#app_index_body').empty();
            $.ajax({
                url: "https://e284-122-170-106-103.ngrok.io/get-code-dicount",
                type: "GET",
                beforeSend: function(xhr){xhr.setRequestHeader('Accept', '*/*');},
                success: function(data) { 
                    // console.log(data); 
